...
@section('content')
    ...
    <div class="t_m pb16">
        <div class="t_m_z">
            <div class="t_lb_t"><a href="/">首页</a>&nbsp;&gt;&nbsp;<a href="/baikequanshu/">百科全书</a>&nbsp;&gt;&nbsp;<a href="/baikequanshu/tianwendili/">科学知识</a>&nbsp;&gt;&nbsp;<a href="/baikequanshu/tianwendili/dilizhishi/">现代科学技术</a></div>
        ...
        <div class="t_auto pb16" id="Mhead2_0" style="display: block;">
            <dl class="txt_box">
                ...
                @for ($i = 0; $i < count($items); $i++)
                    <dd>
                        <a href="/baike/modern_science/{{ $items[$i]->id }}/detail" target="_blank" title="{{ $items[$i]->title }}">{{$i+1}}.{{ $items[$i]->title }}</a>
