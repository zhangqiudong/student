            ...
            <div class="aboutus_box">
                <div class="aboutus_left">
                    ...
                    <ul class="a_box_list">
                        ...
                        <li><a href="javascript:;" class="a_l_nav">网站合作</a></li>
...
<img border="0" title="立即联系广告服务" alt="立即联系广告服务" src="http://wpa.qq.com/pa?p=2:2949246001:51">
                    ...
                    <div class="a_text07" style="display:none;">
                        <div class="a_nr_tit">
                            <h2>联系我们</h2>
                        </div>
                        <div class="a_nr_list">
        ...
        <script>
            $(function () {
                setTimeout(' $(".a_nr_tit").css("backgroud","#ccc")', 2000 );
                function removebg(){
                    $('.a_nr_tit').css("backgroud","#ccc");
                }
            })
        </script>
    </div>
